...
void parmac_setup_full(model_t *p, size_t chunk, int reset) {
    ...
    switch (chunk) {
        ...
        case 0:
            ...
            parameters[i++] = PARAMETER_C99(PARAMETER_TYPE_UINT8, &p->pmac.allarme_inverter_na_nc,              NULL,   NULL,   0,      1,      1,      1,      AL_TECH,     FINT(PARMAC_DESCRIPTIONS_ALLARME_INVERTER_NA_NC),               NULL,       NULL);
