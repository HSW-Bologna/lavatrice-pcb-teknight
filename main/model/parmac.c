...
void parmac_setup_full(model_t *p, size_t chunk, int reset) {
    ...
    switch (chunk) {
        ...
        case 0: // 01
            parameters[i++] = PARAMETER_C99(PARAMETER_TYPE_UINT8, &p->pmac.lingua,                              NULL,   NULL,   0,      3,      0,      1,      AL_USER,     FINT(PARMAC_DESCRIPTIONS_LINGUA),                                  NULL,       NULL);
            parameters[i++] = PARAMETER_C99(PARAMETER_TYPE_UINT8, &p->pmac.lingua_max,                          NULL,   NULL,   1,      4,      4,      1,      AL_TECH,     FINT(PARMAC_DESCRIPTIONS_LINGUA_MAX),                              NULL,       NULL);
