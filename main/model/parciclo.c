...
//  parameters[j++] = PARAMETER_C99(PARAMETER_TYPE_UINT8, &p->pciclo[i].tipo_asciugatura_m_a,               NULL,   NULL,   0,   1,    0,    1,    AL_TECH,     FINT(PARMAC_DESCRIPTIONS_TIPO_ASCIUGATURA_M_A),             NULL,       NULL);
    parameters[j++] = PARAMETER_C99(PARAMETER_TYPE_UINT8, &p->pciclo[i].tipo_asciugatura_m_a,               NULL,   NULL,   0,   1,    0,    1,    AL_USER,     FINT(PARMAC_DESCRIPTIONS_TIPO_ASCIUGATURA_M_A),             NULL,       NULL);
...
//  parameters[j++] = PARAMETER_C99(PARAMETER_TYPE_UINT8, &p->pciclo[i].umidita_residua_dry_auto,           NULL,   NULL,   5,   50,   30,   1,    AL_TECH,     FINT(PARMAC_DESCRIPTIONS_UMIDITA_RESIDUA_DRY_AUTO),         NULL,       NULL);
    parameters[j++] = PARAMETER_C99(PARAMETER_TYPE_UINT8, &p->pciclo[i].umidita_residua_dry_auto,           NULL,   NULL,   5,   50,   30,   1,    AL_USER,     FINT(PARMAC_DESCRIPTIONS_UMIDITA_RESIDUA_DRY_AUTO),         NULL,       NULL);
