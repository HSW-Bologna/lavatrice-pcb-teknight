#include <stdint.h>
#include "peripherals/display/display_common.h"
#include "driver/spi_master.h"
#include "driver/gpio.h"
#include "driver/ledc.h"

#define RETRO GPIO_NUM_18
...
{
    gpio_set_level(DISP_SPI_RESET, res);
}
...
void init_display_spi(void)
{
    ...
    io_conf.pin_bit_mask = ((1ULL << DISP_SPI_RESET) | (1ULL << DISP_SPI_DC));
